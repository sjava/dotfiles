local config = {
    ...
    plugins = {
        ...
        init = {
            ...
            }, {"vim-test/vim-test"}, {"andymass/vim-matchup"},
            {"mg979/vim-visual-multi", branch = "master"},
            {"elixir-editors/vim-elixir"}, {"chemzqm/wxapp.vim"},
            {"rainbowhxch/beacon.nvim"}, {"linty-org/readline.nvim"},
            {
                'nacro90/numb.nvim',
            ...
            }, {"chrisbra/NrrwRgn"}, {"sbdchd/neoformat"},
            {"wellle/targets.vim"}, {
            ...
            config.sources = {
                ...
                null_ls.builtins.formatting.prettier.with({
                    extra_args = function(params)
                        return {"--parser", parsers[params.ft]}
                    end
                }), -- Set a linter
        ...
        server_registration = function(server, opts)
            if server == "rust_analyzer" then
                require("rust-tools").setup({
                    server = vim.tbl_deep_extend("force", {standalone = true},
                                                 opts)
                })
            else
